...
savefilename += f"_both_crop_twomix_replace_{thres_crop}"
...
for data in datalist:
    ...
    # crop augmentation
    new_crop_data = new_crop_data = crop_twomix(data, moments=moments, non_moments=non_moments, thres_crop=thres_crop, ctx_l=ctx_l, clip_len=clip_len, db_range=db_range, moment_db=moment_db)
    if new_crop_data:
